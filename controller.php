...
class Controller {
    ...
    public function categories(){
        $table = "categories";
        $column = "*";
        $condition = "WHERE status = ? ORDER BY id DESC";
        $data_types = "i";
        $post_datas = array("1");
    ...
    public function categoryImages(){
        ...
        global $categoryImageModel;
        $categoryImageModel = $this->model('categoryImageModel');
        $categoryImages = $categoryImageModel->select_all($post_datas,$data_types,$table,$column,$condition);
    ...
    public function postImages(){
        ...
        global $postImageModel;
        $postImageModel = $this->model('postImageModel');
        $postImages = $postImageModel->select_all($post_datas,$data_types,$table,$column,$condition);
        return $postImages;
    }
